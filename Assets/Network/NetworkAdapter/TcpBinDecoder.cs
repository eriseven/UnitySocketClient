...
public class TcpBinDecoder
{
    ...
    //解包头部分
    public virtual byte[] DecodeHead(byte[] input, int length)
    {
        return null;
    }

    //组包头部分
    public virtual byte[] EncodeHead(byte[] input, int length)
    {
    ...
    public virtual byte[] Decode(byte[] input, int length)
    {
